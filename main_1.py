...
all_lines =  ["🕒更新时间,#genre#"] +[version]  +[about] +[daily_mtv]+read_txt_to_array('专区/about.txt') + ['\n'] +\
             ["🌐央视,#genre#"] + sort_data(ys_dictionary,correct_name_data(corrections_name,ys_lines)) + ['\n'] + \
             ["📡卫视,#genre#"] + sort_data(ws_dictionary,correct_name_data(corrections_name,ws_lines)) + ['\n'] + \
             ["🐉数字,#genre#"] + sort_data(sz_dictionary,set(correct_name_data(corrections_name,sz_lines))) + ['\n'] + \
             ["☘️湖北,#genre#"] + sort_data(hb_dictionary,set(correct_name_data(corrections_name,hb_lines))) + ['\n'] + \
             ["☘️湖南,#genre#"] + sort_data(hn_dictionary,set(correct_name_data(corrections_name,hn_lines))) + ['\n'] + \
             ["☘️浙江,#genre#"] + sort_data(zj_dictionary,set(correct_name_data(corrections_name,zj_lines))) + ['\n'] + \
             ["☘️广东,#genre#"] + sort_data(gd_dictionary,set(correct_name_data(corrections_name,gd_lines))) + ['\n'] + \
             ["☘️山东,#genre#"] + sort_data(shandong_dictionary,set(correct_name_data(corrections_name,shandong_lines))) + ['\n'] + \
             ["☘️江苏,#genre#"] + sorted(set(correct_name_data(corrections_name,jsu_lines))) + ['\n'] + \
             ["☘️安徽,#genre#"] + sorted(set(correct_name_data(corrections_name,ah_lines))) + ['\n'] + \
             ["☘️海南,#genre#"] + sorted(set(correct_name_data(corrections_name,hain_lines))) + ['\n'] + \
             ["☘️内蒙,#genre#"] + sorted(set(correct_name_data(corrections_name,nm_lines))) + ['\n'] + \
             ["☘️辽宁,#genre#"] + sorted(set(correct_name_data(corrections_name,ln_lines))) + ['\n'] + \
             ["☘️陕西,#genre#"] + sorted(set(correct_name_data(corrections_name,sx_lines))) + ['\n'] + \
             ["☘️山西,#genre#"] + sorted(set(correct_name_data(corrections_name,shanxi_lines))) + ['\n'] + \
             ["☘️云南,#genre#"] + sorted(set(correct_name_data(corrections_name,yunnan_lines))) + ['\n'] + \
             ["☘️北京,#genre#"] + sorted(set(correct_name_data(corrections_name,bj_lines))) + ['\n'] + \
             ["☘️重庆,#genre#"] + sorted(set(correct_name_data(corrections_name,cq_lines))) + ['\n'] + \
             ["☘️福建,#genre#"] + sorted(set(correct_name_data(corrections_name,fj_lines))) + ['\n'] + \
             ["☘️甘肃,#genre#"] + sorted(set(correct_name_data(corrections_name,gs_lines))) + ['\n'] + \
             ["☘️广西,#genre#"] + sorted(set(correct_name_data(corrections_name,gx_lines))) + ['\n'] + \
             ["☘️贵州,#genre#"] + sorted(set(correct_name_data(corrections_name,gz_lines))) + ['\n'] + \
             ["☘️河北,#genre#"] + sorted(set(correct_name_data(corrections_name,heb_lines))) + ['\n'] + \
             ["☘️河南,#genre#"] + sorted(set(correct_name_data(corrections_name,hen_lines))) + ['\n'] + \
             ["☘️吉林,#genre#"] + sorted(set(correct_name_data(corrections_name,jl_lines))) + ['\n'] + \
             ["☘️江西,#genre#"] + sorted(set(correct_name_data(corrections_name,jx_lines))) + ['\n'] + \
             ["☘️宁夏,#genre#"] + sorted(set(correct_name_data(corrections_name,nx_lines))) + ['\n'] + \
             ["☘️青海,#genre#"] + sorted(set(correct_name_data(corrections_name,qh_lines))) + ['\n'] + \
             ["☘️四川,#genre#"] + sorted(set(correct_name_data(corrections_name,sc_lines))) + ['\n'] + \
             ["☘️天津,#genre#"] + sorted(set(correct_name_data(corrections_name,tj_lines))) + ['\n'] + \
             ["☘️新疆,#genre#"] + sorted(set(correct_name_data(corrections_name,xj_lines))) + ['\n'] + \
             ["☘️黑龙江,#genre#"] + sorted(set(correct_name_data(corrections_name,hlj_lines))) + ['\n'] + \
             ["☕️解说,#genre#"] + sorted(set(js_lines)) + ['\n'] + \
             ["🎞️电影,#genre#"] + read_txt_to_array('专区/♪电影点播.txt') + ['\n'] + \
             ["🔁电视剧,#genre#"] + read_txt_to_array('专区/♪电视剧.txt') + ['\n'] + \
             ["🌈港澳台,#genre#"] + read_txt_to_array('专区/♪港澳台.txt') + ['\n'] + \
             ["🌐台湾,#genre#"] + read_txt_to_array('专区/♪台湾台.txt') + ['\n'] + \
             ["📶优质,#genre#"] + read_txt_to_array('专区/♪优质源.txt') + ['\n'] + \
             ["📚儿童,#genre#"] + read_txt_to_array('专区/♪儿童专享.txt') + ['\n'] + \
             ["🍑定制,#genre#"] + read_txt_to_array('专区/♪定制源.txt') + ['\n'] + \
             ["☕️定制P3P,#genre#"] + read_txt_to_array('专区/p3p.txt') + ['\n'] + \
             ["📶英语,#genre#"] + read_txt_to_array('专区/♪英语频道.txt') + ['\n'] + \
             ["📡4K测试,#genre#"] + read_txt_to_array('专区/4K.txt') + ['\n'] + \
             ["🏆️SPORTS,#genre#"] + read_txt_to_array('专区/♪sports.txt') + ['\n'] + \
             ["🏈赛事,#genre#"] + sorted(set(normalized_tyss_lines)) + ['\n'] + \
             ["⚽️体育,#genre#"] + sort_data(ty_dictionary,set(correct_name_data(corrections_name,ty_lines))) + ['\n'] + \
             ["🍓春晚,#genre#"] + sort_data(cw_dictionary,set(cw_lines))  + ['\n'] + \
             ["📺咪咕,#genre#"] + read_txt_to_array('专区/♪咪咕直播.txt') + ['\n'] + \
             ["🚀AKTV📶,#genre#"] + aktv_lines + ['\n'] + \
             ["🎵MTV,#genre#"] + sorted(set(correct_name_data(corrections_name,mtv_lines))) + ['\n'] + \
             ["🎧收音机,#genre#"] + sort_data(radio_dictionary,set(radio_lines))  + ['\n'] + \
             ["🐉专享🅰️,#genre#"] + read_txt_to_array('专区/♪专享源①.txt') + ['\n'] + \
             ["🐯专享🅱️,#genre#"] + read_txt_to_array('专区/♪专享源②.txt') + ['\n'] + \
             ...
             ["雪中悍刀行,#genre#"] + read_txt_to_array('专区/特供频道/♪雪中悍刀行.txt') + ['\n'] + \
             ["以家人之名,#genre#"] + read_txt_to_array('专区/特供频道/♪以家人之名.txt')
